            ...
            <Paper elevation={0} sx={{ p: { xs: 3, sm: 4 }, bgcolor: 'grey.50' }}>
              ...
              <Box sx={{ 
                ...
                <Box sx={{ textAlign: { xs: 'center', sm: 'left' } }}>
                  <Typography paragraph>
                    Booksy was founded by Tathagata Dey, a passionate software developer and book enthusiast. 
                    With a vision to create a modern, user-friendly platform for book lovers, Tathagata 
